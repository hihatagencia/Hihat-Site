      ...
      <section id="servicos" style={secDark}>
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          <div style={{ marginTop: 48, paddingTop: 24, borderTop: '1px solid var(--border)', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
            ...
            <button onClick={() => scroll('contato')} style={{ background: 'none', border: 'none', fontFamily: 'var(--sans)', fontWeight: 700, cursor: 'pointer', background: 'var(--grad-text)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontSize: 14 }}>
              Falar agora →
            </button>
          </div>
        </div>
